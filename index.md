...
- **2026**
  ...
  Zhikui Chen, **Liu Meng**, Yuzhe Li, Zheng Hao, Liu Zhenjiao, Zhang Hongwei, Zhao Liang.  (**Information Sciences CCF-B**)
  ...
  - **PRIME: A Decoupled Multi-Agent Actor-Critic for Multi-view Clustering**. \\
   Gao Jing, Liu Xinxin, Li Peng, Zhang Jianing, **Liu Meng**, Zhang Qingchen. (**IJCAI CCF-B**)
  ...
  Chen Zhikui, Zhou Yu, **Liu Meng**.  (**ICASSP CCF-B**)
  - **LKAFormer: A lightweight kolmogorov-arnold transformer model for image semantic segmentation**. \\
  Yin Shoulin, Wang Liguo, Chen Tao, Huang Huafei, Gao Jing, Zhang Jianing, **Liu Meng**, Li Peng, Xu Chengpei.  (**ACM Transactions on Intelligent Systems and Technology**)
  
 

- **2025**
  - **Information-Driven Complementarity and Consistency Mining for Multi-View Clustering**.\\
   **Liu Meng**, Li Yuzhe, Chen Zhikui, Lin Yilong.  (**SPL CCF-C**)
  - **Empowering Sustainability in Power Grids: A Multi-Scale Adaptive Load Forecasting Framework with Expert Collaboration**.\\
   Tian Zengyao, Deng Wenchen, **Liu Meng**, Lv Li, Chen Zhikui. (**Sustainability**)
  - **Dynamic-static feature fusion with multi-scale attention for continuous blood glucose prediction**.\\
   Gao Jing, Guo Chenhua, Liu Yingshu, Li Peng, Zhang Jianing, **Liu Meng**. (**ICASSP CCF-B**)
  - **LLM-Empowered Time Series Prediction with Cross-Modal Fusion**.\\
   Wan Xingheng, **Liu Meng**, Li Yuzhe, Yang Tian, Zhang Shuhao, Chen Zhikui. (**BIBM CCF-B**)
...
- **2024**
  ...
  Gao Jing,  **Liu Meng**, Li Peng, Laghari Asif Ali, Javed Abdul Rehman, Victor, Nancy, Gadekallu, Thippa Reddy. (**IOTJ CCF-C**)
